...
exports.specMiddleware = function(options = {}) {
  ...
  router.get('/crm.json', function(req, res) {
    res.setHeader('Content-Type', 'application/json');
    options['mainFile'] = 'spec/crm.yaml';
    try {
      res.end(exports.stringify(exports.bundle(options), { json: true }));
    } catch (e) {
      console.log(chalk.red('Error while bundling the API definition: ' + e.message));
  ...
  router.get('/crm.yaml', function(req, res) {
    res.setHeader('Content-Type', 'application/yaml');
    options['mainFile'] = 'spec/crm.yaml';
    res.end(exports.stringify(exports.bundle(options), { yaml: true }));
  });
  router.get('/ledger.json', function(req, res) {
    res.setHeader('Content-Type', 'application/json');
    options['mainFile'] = 'spec/ledger.yaml';
    try {
      res.end(exports.stringify(exports.bundle(options), { json: true }));
    } catch (e) {
      console.log(chalk.red('Error while bundling the API definition: ' + e.message));
  ...
  router.get('/ledger.yaml', function(req, res) {
    res.setHeader('Content-Type', 'application/yaml');
    options['mainFile'] = 'spec/ledger.yaml';
    res.end(exports.stringify(exports.bundle(options), { yaml: true }));
  });
